...
function Compiler(options) {
  ...
  if (self.options.cache) {
    self._cache = new NodeCache({
      ...
      checkperiod: self.options.cacheCheckTime
    });
  }
}
 ...
 *   </li>
 *   <li>
 *     <code>cacheCheckTime</code>: Interval, in seconds, to check the cache
 *     for templates to expire (remove). Default value is 300 (5 minutes).
 *   </li>
 *   <li>
