...
Compiler.prototype._if = function _if($dom, context, gContext) {
  const $ifBlocks = $dom('[g-if]');
...
Compiler.prototype._partial = function _partial($dom, context, gContext) {
  const $partials = $dom('[g-partial]');
...
Compiler.prototype._render = function _render(template, context, gContext) {
  ...
  this._partial($dom, context, gContext);
